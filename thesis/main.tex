...
Before we move on to the experiments, we will first be laying out the shared apparatus that each of them relied on. In \S~\ref{sec:kernel_instantiation} we will be describing the precise instantiation of our kernel used to produce the semantic embeddings for the formulae in our datasets. Then, in \S~\ref{sec:model_validation} we will be describing the construction of our dataset used to validate each of the models we trained during the experiments. In \S~\ref{sec:metrics} we describe what metrics were collected during the validation process and in \S~\ref{sec:stats_framework} we describe what statistical conventions back up our analyses.  
