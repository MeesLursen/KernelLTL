...
Because each experiment builds on the previous, we structure this chapter by first introducing the machinery shared across all three, and then presenting each in a self-contained \textit{methodology}, \textit{results}, and \textit{discussion} section.
